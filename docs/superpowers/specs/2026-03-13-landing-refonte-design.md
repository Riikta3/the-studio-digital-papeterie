...
La landing page actuelle est un catalogue basique. L'objectif est de la transformer en une expérience de vente immersive et haut de gamme pour les faire-part digital. Stack : Next.js App Router, React, Tailwind CSS, Framer Motion, shadcn/ui, next-intl.
