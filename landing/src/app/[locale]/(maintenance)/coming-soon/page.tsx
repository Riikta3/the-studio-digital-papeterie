...
export default function ComingSoonPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden flex flex-col items-center justify-center text-center px-4">
      ...
      <OrnamentSvg className="absolute -top-10 -left-10 w-64 h-64 -rotate-[15deg] opacity-[0.07] pointer-events-none" aria-hidden="true" />

      {/* Ornement coin bas-droit */}
      <OrnamentSvg className="absolute -bottom-10 -right-10 w-60 h-60 rotate-[165deg] opacity-[0.07] pointer-events-none" aria-hidden="true" />
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 max-w-lg">
        ...
        <p className="text-[0.6rem] uppercase tracking-[0.28em] text-primary font-medium">
          Faire-part digitaux haut de gamme
        </p>
        ...
        <p className="font-heading italic text-muted-foreground text-[clamp(1rem,2.5vw,1.3rem)] leading-relaxed max-w-sm">
          L&apos;art du faire-part repensé pour l&apos;ère digitale —{" "}
          bientôt disponible.
        </p>
...
function OrnamentSvg({ className, "aria-hidden": ariaHidden }: { className?: string; "aria-hidden"?: boolean | "true" }) {
  return (
    <svg
      className={className}
    ...
    >
      ...
      <path
        ...
        strokeWidth="0.5"
      />
      <line x1="150" y1="0" x2="150" y2="300" stroke="hsl(344,53%,35%)" strokeWidth="0.3" opacity="0.5" />
      <line x1="0" y1="150" x2="300" y2="150" stroke="hsl(344,53%,35%)" strokeWidth="0.3" opacity="0.5" />
      <circle cx="150" cy="150" r="8" stroke="hsl(344,53%,35%)" strokeWidth="1" />
      <path d="M150 30 C150 30 178 80 150 120 C122 80 150 30 150 30Z" fill="hsl(344,53%,35%)" opacity="0.6" />
      <path d="M150 270 C150 270 178 220 150 180 C122 220 150 270 150 270Z" fill="hsl(344,53%,35%)" opacity="0.6" />
      <path d="M30 150 C30 150 80 122 120 150 C80 178 30 150 30 150Z" fill="hsl(344,53%,35%)" opacity="0.6" />
      <path d="M270 150 C270 150 220 122 180 150 C220 178 270 150 270 150Z" fill="hsl(344,53%,35%)" opacity="0.6" />
    </svg>
  );
}
