              ...
              {option.url && (
                <div className='pt-2 mt-auto'>
                  <Button
                    asChild
                    variant='outline'
                    className='w-full rounded-full h-auto py-3.5 px-4 whitespace-normal text-center text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.15em] border-primary/20 bg-background text-foreground/60 hover:bg-muted hover:text-primary hover:border-primary/30 transition-all gap-2'
                  >
                    <a
                      href={option.url}
                      target='_blank'
