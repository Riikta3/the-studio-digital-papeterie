    ...
    <section className="w-full py-20">
      ...
      >
        ...
        <div className="text-center mb-10">
          <p className="text-[10px] uppercase tracking-[0.4em] text-primary font-sans mb-3">
            Votre réponse
          </p>
          <h2
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    >
                      <span className={`${form.attendance === val ? "text-primary" : "text-muted-foreground"} transition-colors`}>{icon}</span>
                      <span className="text-[11px] uppercase tracking-[0.15em] font-sans text-foreground/70">{label}</span>
                    </button>
                  ))}
                </div>
                ...
                {form.attendance === "yes" && (
                  ...
                  >
                    ...
                    <div className={`grid gap-3 ${adultsOnly ? "grid-cols-1" : "grid-cols-2"}`}>
                      {([
                        ...
                        <div key={key} className="flex flex-col gap-2">
                          <p className="text-[10px] uppercase tracking-[0.2em] text-foreground/40 font-sans px-1">{label}</p>
                          <div className="flex items-center justify-between bg-muted/50 border border-border rounded-full px-3 py-2">
                            ...
                            <span className="text-sm font-semibold text-foreground w-6 text-center">{form[key]}</span>
                            <button
                              type="button"
                    ...
                    <div className="flex flex-col gap-2">
                      <p className="text-[10px] uppercase tracking-[0.2em] text-foreground/40 font-sans px-1">Régime alimentaire (optionnel)</p>
