        ...
        <div className='bg-card rounded-[2rem] p-8 md:p-12 border border-primary/20 shadow-[0_4px_24px_-8px_rgba(0,0,0,0.08)] max-w-2xl mx-auto flex flex-col items-center transition-all duration-500'>
          ...
          <div className='w-full max-w-md relative'>
            <div className='relative flex items-center'>
              ...
              <input
                ...
                className='w-full bg-card border border-primary/20 text-foreground placeholder:text-muted-foreground/50 rounded-full py-4 pl-14 pr-6 focus:outline-none focus:ring-1 focus:ring-primary/40 focus:border-primary/60 transition-all font-light shadow-sm hover:border-primary/30 disabled:bg-secondary disabled:cursor-not-allowed disabled:opacity-70'
              />
            </div>
          ...
          <AnimatePresence>
            {results.length > 0 && !isSearching && (
              <motion.div
                ...
                className='w-full max-w-md mt-6 bg-muted/50 rounded-2xl border border-primary/20 overflow-hidden'
              >
          ...
          <AnimatePresence>
            {addedTracks.size > 0 && (
              ...
              >
                <h4 className='text-xs font-bold uppercase tracking-[0.15em] text-foreground/60 mb-6 text-left w-full pl-2'>
                ...
                <div className='flex flex-col gap-3'>
                  {Array.from(addedTracks.values()).map((track) => (
                    <motion.div
                      ...
                      className='flex items-center gap-4 bg-card border border-primary/20 p-3 rounded-2xl group transition-all hover:bg-card hover:border-primary/30 hover:shadow-sm'
                    >
                      <img
                        src={track.coverUrl}
                        alt={track.title}
                      ...
                      <button
                        ...
                        className='w-8 h-8 rounded-full flex items-center justify-center text-foreground/60 hover:bg-[#FEE2E2] hover:text-[#EF4444] transition-all bg-secondary shrink-0'
                      >
