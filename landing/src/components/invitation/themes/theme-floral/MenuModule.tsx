    ...
    <section className='w-full'>
      ...
      >
        ...
        <div className='px-8 py-20 md:px-16 md:py-24 text-center'>
          <Utensils className='w-10 h-10 text-[#c97a90] mx-auto mb-16 opacity-70 stroke-[1.5]' />
              ...
              >
                ...
                <div className='space-y-8'>
                  {section.items.map((item, idx) => (
                    <div key={idx}>
                      <p className='font-heading text-3xl md:text-4xl text-[#5a3040]/90 transition-colors group-hover:text-primary leading-tight px-4 mb-2'>
                        {item.title}
                      </p>
                      {item.description && (
                        <p className='italic text-[#5a3040]/60 font-light text-base md:text-lg max-w-sm mx-auto'>
                          {item.description}
                        </p>
                      )}
                    </div>
