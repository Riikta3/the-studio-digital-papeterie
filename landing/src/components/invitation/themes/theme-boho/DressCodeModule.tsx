      ...
      >
        ...
        {isSplit ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-2xl mx-auto">
            {/* Men */}
            <div className="bg-white rounded-[2rem] p-8 md:p-10 border border-[#a98467]/20 shadow-xl flex flex-col items-center gap-4">
              <div className="w-14 h-14 bg-secondary rounded-full flex items-center justify-center text-[#a98467]">
                <Shirt className="w-5 h-5 opacity-80" />
              </div>
              <p className="text-xs font-bold uppercase tracking-[0.15em] text-[#4a3728]/60">
                Homme
              </p>
              <p className="text-[#4a3728]/60 text-sm md:text-base leading-relaxed font-light">
          ...
          <div className="bg-white rounded-[2rem] p-10 md:p-14 border border-[#a98467]/20 shadow-xl max-w-2xl mx-auto flex flex-col items-center">
            <div className="w-16 h-16 bg-secondary rounded-full flex items-center justify-center mb-6 text-[#a98467]">
