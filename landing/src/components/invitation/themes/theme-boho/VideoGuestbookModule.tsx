      ...
      <section className='w-full py-10'>
        ...
        >
          ...
          <button
            ...
            className='mt-10 text-xs font-bold uppercase tracking-widest text-[#a98467] underline'
          >
  ...
  return (
    <section className='w-full'>
      ...
      >
        ...
        <h2 className='font-heading text-5xl md:text-6xl text-[#4a3728] mb-8'>
          Livre d'Or{" "}
          <span className='italic text-[#a98467] opacity-80'>Vidéo</span>
        </h2>

        <div className='bg-white rounded-[2.5rem] p-8 md:p-16 border border-[#a98467]/20 shadow-xl max-w-2xl mx-auto'>
          {!previewUrl ? (
            <div className='space-y-8'>
              <div className='w-20 h-20 bg-secondary rounded-full flex items-center justify-center mx-auto text-[#a98467]'>
                <Camera className='w-10 h-10' />
              </div>
              <div className='space-y-4 max-w-sm mx-auto'>
                <p className='text-[#4a3728]/60 text-base md:text-lg leading-relaxed font-light'>
              ...
              <button
                ...
                className='w-full bg-[#a98467] hover:bg-primary/90 text-white py-5 rounded-full font-bold text-xs uppercase tracking-[0.3em] transition-all duration-300 shadow-xl shadow-primary/10 flex items-center justify-center gap-3'
              >
            ...
            <div className='space-y-8'>
              ...
              <div className='space-y-4'>
                <button
                  ...
                  className='w-full bg-[#a98467] hover:bg-primary/90 disabled:bg-[#CCCCCC] text-white py-5 rounded-full font-bold text-xs uppercase tracking-[0.3em] transition-all duration-100 flex items-center justify-center gap-3'
                >
                  {status === "submitting" ? (
                    <>
                      Envoi en cours...{" "}
