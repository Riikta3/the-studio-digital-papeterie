    ...
    >
      ...
      >
        ...
        >
          ...
          {/* Main Image */}
          <div
            className={`relative w-full aspect-[4/3] md:aspect-[16/9] rounded-[2rem] overflow-hidden bg-white border border-[#c97a90]/20 shadow-2xl ${isDemo ? "cursor-default" : "cursor-zoom-in"}`}
            ...
            {images.map((_, i) => (
              ...
              >
                ...
                {i === current && (
                  <motion.span
                    layoutId='indicator'
                    className='absolute inset-0 bg-[#c97a90]'
            ...
            {images.map((src, i) => (
              <button
                ...
                className={`relative shrink-0 w-14 h-14 md:w-16 md:h-16 mt-1 rounded-xl overflow-hidden transition-all duration-300 ${
                  i === current
                    ? "ring-2 ring-[#c97a90] ring-offset-2 shadow-md scale-105"
