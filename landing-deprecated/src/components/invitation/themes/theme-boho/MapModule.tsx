  ...
  return (
    <section className='w-full'>
      <div className='text-center mb-20 space-y-4'>
        <h2 className='text-sm font-bold uppercase tracking-widest text-[#a98467]'>
          Lieu de Réception
        </h2>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <h4 className='font-heading text-3xl md:text-5xl text-[#4a3728]/90 leading-tight'>
                {location.name}
              </h4>
              <p className='text-[#4a3728]/60 font-light text-base md:text-lg leading-relaxed'>
              ...
              >
                ...
                >
                  <MapPin className='w-4 h-4 text-[#a98467]' />
                  Adresse du domaine
                </p>
                <div
                  className={`text-[#4a3728]/90 text-base leading-relaxed ${!location.imageUrl ? "pl-0" : "pl-7"}`}
                >
            ...
            >
              ...
              <a
                ...
                className='w-full rounded-[2rem] border border-primary/30 bg-transparent hover:bg-primary/5 transition-colors flex items-center justify-center gap-3 py-4 px-6 text-xs font-bold uppercase tracking-widest text-[#4a3728]/90'
              >
                <Navigation className='w-4 h-4 text-primary/80' />
                <span>Ouvrir dans Google Maps</span>
                <ExternalLink className='w-3 h-3 text-[#4a3728]/60 ml-1' />
              </a>
            </div>
          </div>
        </div>
