    ...
    <section className='w-full'>
      ...
      >
        ...
        <div className='text-center mb-12'>
          <h2 className='font-heading text-4xl md:text-5xl text-[#4a3728]'>
            Questions{" "}
            <span className='italic text-[#a98467] opacity-80'>Fréquentes</span>
          </h2>
        </div>
        ...
        <div className='space-y-4'>
          {data.questions.map((faq, index) => (
            <motion.div
              ...
              className='bg-white rounded-[1.5rem] border border-[#a98467]/20 shadow-[0_4px_20px_-10px_rgba(0,0,0,0.05)] overflow-hidden transition-all duration-300'
            >
              <button
                onClick={() => setOpenIndex(openIndex === index ? null : index)}
                className='flex w-full items-center justify-between p-7 text-left transition-colors hover:bg-muted'
              >
                <span className='font-heading text-xl md:text-2xl text-[#4a3728] pr-8 leading-snug'>
                  {faq.question}
                </span>
                <div
                  className={cn(
                    ...
                    openIndex === index
                      ? "bg-[#a98467] border-[#a98467] text-white rotate-180"
                      : "border-primary/30 text-[#a98467]",
                  )}
                >
                  {openIndex === index ? (
                ...
                {openIndex === index && (
                  ...
                  >
                    <div className='px-7 pb-8 pt-0'>
                      ...
                      <p className='text-[#4a3728]/60 text-base leading-relaxed font-light'>
                        {faq.answer}
                      </p>
                    </div>
                  </motion.div>
