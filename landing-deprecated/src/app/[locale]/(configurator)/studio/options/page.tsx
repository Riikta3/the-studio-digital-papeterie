  ...
  return (
    <StepTransition>
      <div className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-6 max-w-lg mx-auto w-full px-4 md:grid md:grid-cols-2 md:gap-10 md:items-start md:max-w-4xl md:px-8">
                ...
                {EXTRAS.map((ex) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <div>
                        <p className="text-[12px] font-bold leading-tight">{ex.name}</p>
